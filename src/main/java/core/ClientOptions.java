...
public final class ClientOptions {
  ...
  private ClientOptions(Environment environment, Map<String, String> headers,
    ...
    this.headers.putAll(new HashMap<String,String>() {{put("User-Agent", "berrycrawl/0.2.0");put("X-Fern-Language", "JAVA");put("X-Fern-SDK-Name", "com.berrycrawl:berrycrawl");put("X-Fern-SDK-Version", "0.2.0");}});
