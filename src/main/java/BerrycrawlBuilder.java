...
public class BerrycrawlBuilder {
   ...
   */
  public BerrycrawlBuilder apiKey(String apiKey) {
    this.apiKey = apiKey;
    return this;
  }

  public BerrycrawlBuilder environment(Environment environment) {
    this.environment = environment;
    return this;
  }

  public BerrycrawlBuilder url(String url) {
   ...
   */
  public BerrycrawlBuilder timeout(int timeout) {
   ...
   */
  public BerrycrawlBuilder maxRetries(int maxRetries) {
   ...
   */
  public BerrycrawlBuilder initialRetryDelayMillis(long initialRetryDelayMillis) {
   ...
   */
  public BerrycrawlBuilder maxRetryDelayMillis(long maxRetryDelayMillis) {
   ...
   */
  public BerrycrawlBuilder retryJitterFactor(double retryJitterFactor) {
   ...
   */
  public BerrycrawlBuilder httpClient(OkHttpClient httpClient) {
   ...
   */
  public BerrycrawlBuilder logging(LogConfig logging) {
   ...
   */
  public BerrycrawlBuilder addHeader(String name, String value) {
