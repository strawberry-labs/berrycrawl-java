...
import com.berrycrawl.core.LogConfig;
...
public class AsyncBerrycrawlBuilder {
  ...
  private String apiKey = System.getenv("BERRYCRAWL_API_KEY");
  ...
  /**
   * Sets apiKey.
   * Defaults to the BERRYCRAWL_API_KEY environment variable.
   */
  public AsyncBerrycrawlBuilder apiKey(String apiKey) {
    this.apiKey = apiKey;
    return this;
  }

  public AsyncBerrycrawlBuilder environment(Environment environment) {
    this.environment = environment;
    return this;
  }

  public AsyncBerrycrawlBuilder url(String url) {
   ...
   */
  public AsyncBerrycrawlBuilder timeout(int timeout) {
   ...
   */
  public AsyncBerrycrawlBuilder maxRetries(int maxRetries) {
   ...
   */
  public AsyncBerrycrawlBuilder initialRetryDelayMillis(long initialRetryDelayMillis) {
   ...
   */
  public AsyncBerrycrawlBuilder maxRetryDelayMillis(long maxRetryDelayMillis) {
   ...
   */
  public AsyncBerrycrawlBuilder retryJitterFactor(double retryJitterFactor) {
   ...
   */
  public AsyncBerrycrawlBuilder httpClient(OkHttpClient httpClient) {
   ...
   */
  public AsyncBerrycrawlBuilder logging(LogConfig logging) {
   ...
   */
  public AsyncBerrycrawlBuilder addHeader(String name, String value) {
  ...
  public AsyncBerrycrawl build() {
    if (apiKey == null) {
      throw new RuntimeException("Please provide apiKey or set the BERRYCRAWL_API_KEY environment variable.");
    }
    validateConfiguration();
    return new AsyncBerrycrawl(buildClientOptions());
  }
}
